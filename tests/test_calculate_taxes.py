...
from src.calculate_taxes import calculate_tax, calculate_taxes
...
@pytest.mark.parametrize(
    "tax_rate, expected",
    [(10, [110, 220, 330]), (15, [115, 230, 345]), (20, [120, 240, 360])],
)
...
#    @pytest.fixture()
#    def discount():
#        return ['3', 5, (1, 2, 3), [10, 20]]


@pytest.mark.parametrize(
    "price, tax_rate, discount, expected", [(100, 10, 0, 110), (50, 5, 10, 47.25)]
)
...
@pytest.mark.parametrize(
    "round_digits, expected", [(0, 99), (1, 99.4), (2, 99.42), (3, 99.425)]
)
...
@pytest.mark.parametrize(
    "price, tax_rate, discount, round_digits",
    [("100", 10, 0, 1), (100, "10", 10, 1), (100, 10, "100", 1), (100, 10, 100, "1")],
)
